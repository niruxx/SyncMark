...
- Clean flat design: solid flat colors (no gradients, blur, or drop shadows on the UI itself), a centered max-width layout, Roboto typeface, and smooth animated transitions between pages (via the CSS View Transitions API, where supported)
...
- Account management (👤 button, top right): change your username or password, each re-confirmed with your current password
...
| ![Bookmarks, list view](docs/screenshots/02-bookmarks-list.png) Bookmarks — list view, with the folder tree and search/sort toolbar | ![Bookmarks, grid view](docs/screenshots/03-bookmarks-grid.png) Bookmarks — grid view, with favicons |
| ![Settings page](docs/screenshots/04-settings.png) Settings — appearance, session, import/export, and account danger zone | |
